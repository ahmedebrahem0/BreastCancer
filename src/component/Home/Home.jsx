...
export default function Home() {
  ...
  toast("I hope you are in good health", {
    position: "top-right",
    className: "foo-bar",
  });
  toast(
      ...
      <div>
        ...
        <div className="home vh-100 mb-5">
          <div className="container vh-100 d-flex align-items-center justify-content-around">
            <div className="row m-0 d-flex align-items-center justify-content-around overflow-hidden">
              <div className="col-md-6 d-flex align-items-center justify-content-between mt-5">
                <div className="home-text text-home w-100">
                  ...
                  {/* <button className='btn btn-dark' onClickCapture={notify} >Notify !</button> */}
                  <ToastContainer />
                  ...
                  <div className="btn-login">
                    <button className="mt-3 home-button animate__animated animate__wobble">
                      <NavLink className="text-light">Login</NavLink>
                    </button>
                  </div>
                </div>
              </div>
      ...
      <div className="treat-all mt-5">
        <div className="container ">
          <div className="row ">
            ...
            <div className="mt-2 ">
              <div className="tret1">
                <div className="tret-img overflow-hidden col-md-5 animate__fadeInLeft animate__animated">
                  <img src={Bahey} className="w-100" alt="Bahey.jpg" />
                </div>
                <div className="col-md-6 ">
                  <div className="tret-text animate__fadeInDown animate__animated">
                  ...
                  <div className="ul-all">
                    <ul
                      className="mt-4 d-flex social-media social-media--no-radius list--unstyled overflow-hidden"
            ...
            <div className="col-md-12 my-2">
              <div className="tret2">
                ...
                <div className="tret-img overflow-hidden col-md-5 animate__fadeInRight animate__animated">
                  <img
                    src={Children}
                    className="w-100"
                    height={"331.43px"}
            ...
            <div className="col-md-12 mb-3">
              <div className="tret3">
                ...
                <div className="col-md-6 ">
                  <div className="tret-text animate__animated animate__fadeInDown">
                ...
                <div className="accordion-item animate__animated animate__fadeInLeft">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      work closely with their healthcare team to develop a
                      personalized treatment plan and to monitor their progress
                      closely.
                    </div>
                  </div>
                </div>
